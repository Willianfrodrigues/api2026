...
META_METRICS = [
    ...
    # Video
    {"id":"video_view","label":"Three-second video views"},
    {"id":"unique_video_view_3s","label":"Unique three-second video views"},
    ...
    {"id":"ten_sec_video_view","label":"Ten-second video views"},
